...
public class FinallBoss extends Enemy {
    ...
    public FinallBoss(TileMap tilemap,int range,Hero hero){
        super(tilemap);
        ...
        faceRight=true;
        faceDown=true;
        sprites.add(Assets.bosssliderup);
        sprites.add(Assets.bossslideright);
        sprites.add(Assets.bosssliderdown);
        sprites.add(Assets.bossskillfirst);
        sprites.add(Assets.bossskillsecond);
        sprites.add(Assets.bossulti);
        sprites.add(Assets.idleboss);
        animation=new Animation();
        currentAction=IDLE;
        animation.setFrames(Assets.idleboss);
