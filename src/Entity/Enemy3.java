...
public class Enemy3 extends Enemy {
    ...
    public Enemy3(TileMap tilemap,int range,Hero hero){
        super(tilemap);
        ...
        faceRight=true;
        faceDown=true;
        sprites.add(Assets.eviltankrunup);
        sprites.add(Assets.eviltankrunright);
        sprites.add(Assets.eviltankrundown);
        sprites.add(Assets.idleeviltank);
        sprites.add(Assets.eviltankfightright);
        sprites.add(Assets.eviltankfightup);
        sprites.add(Assets.eviltankfightdown);
        animation=new Animation();
        currentAction=IDLE;
        animation.setFrames(Assets.idleeviltank);
